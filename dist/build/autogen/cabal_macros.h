...
/* package iso8601-time-0.1.2 */
#define VERSION_iso8601_time "0.1.2"
#define MIN_VERSION_iso8601_time(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 2)

/* package lens-4.4.0.2 */
#define VERSION_lens "4.4.0.2"
...
/* package wreq-0.2.0.0 */
#define VERSION_wreq "0.2.0.0"
